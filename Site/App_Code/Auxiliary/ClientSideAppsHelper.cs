...
public class ClientSideAppsHelper
{
	...
	public static string RenderScriptConfiguration()
	{
		...
		string cachedResult = HttpContext.Current.Cache["ClientSideAppsConfig"] as string;
...
", HttpUtility.HtmlDecode(PX.Data.PXMessages.LocalizeNoPrefix(PX.Web.UI.Msg.SuggesterNothingFound)));
...
requirejs = {{
	...
	bundles: {{{1}}}
		...
		HttpContext.Current.Cache.Insert("ClientSideAppsConfig", result, new System.Web.Caching.CacheDependency(bundleFiles), System.Web.Caching.Cache.NoAbsoluteExpiration, System.Web.Caching.Cache.NoSlidingExpiration);
