...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXTab ID="tab" runat="server" DataSourceID="ds" Height="400px" Style="z-index: 100"
		...
		<Items>
				...
				<Template>
					...
					<px:PXFormView ID="formUserPrefs" runat="server" DataMember="UserPrefs" RenderStyle="Simple">
						<Template>
							...
							<px:PXSelector ID="edDefprinter" runat="server" DataField="DefaultPrinter" CommitChanges="True" AutoRefresh="true"/>
							<px:PXSelector ID="edDefaultScales" runat="server" DataField="DefaultScales" CommitChanges="True" AutoRefresh="true"/>
			...
			<px:PXTabItem Text="Printing Settings" LoadOnDemand="True">
				<Template>
					<px:PXGrid ID="gridNS" runat="server" SkinID="DetailsInTab" Width="100%" DataSourceID="ds" Height="150px" Caption="Default Printers" AdjustPageSize="Auto" AllowPaging="True">
						<Levels>
							<px:PXGridLevel DataMember="Notifications">
								...
								<Columns>
									...
									<px:PXGridColumn DataField="DefaultPrinter" />
