...
<asp:Content ID="Content3" ContentPlaceHolderID="phUser" Runat="Server">
	...
	<div runat="server" id="divEula" Visible="false" style="margin-bottom: 10px;">
		<asp:CheckBox runat="server" ID="chkEula" OnClick="onchkEulaСhanged(this.checked);" Style="float: left" />
	...
	<div id="multiFactorTip" class="multi-factor-tip" style="display: none;">
		<div class="auth-caption">
			<i id="multiFactorIcon" class="ac ac-phone_iphone"></i>
        ...
        <div id="noDeviceSend" style="display: none; clear: both">
	        ...
	        <input id="noDeviceSendButton" name="noDeviceSendButton" value="<%=PX.Data.PXLocalizer.Localize(PX.AscxControlsMessages.LoginScreen.SendRequestToDevice)%>" onclick="startProviderSend('MobilePush', false, 'phone_iphone', true);" 
	    ...
	    function startHub(retryCounter) {
	        ...
	        $.connection.hub.start()
	            .done(function ()
	            {
	                ...
	                startProviderSend("MobilePush", false, "phone_iphone", false);
	            })
	            .fail(function (e) {
